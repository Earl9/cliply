...
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "不卸载（此安装器不允许直接降级）"
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法关闭 {{product_name}}。请手动退出后重试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2..."
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装更新版本的 ${PRODUCTNAME}。不建议安装旧版本。如需继续，请先卸载当前版本。"
LangString older ${LANG_SIMPCHINESE} "较旧"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装一个$R4版本的 ${PRODUCTNAME}。建议先卸载当前版本再继续安装。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装器不允许静默降级，请使用图形界面安装器。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "WebView2 安装失败。应用需要 WebView2 才能运行，请重新启动安装器。"
