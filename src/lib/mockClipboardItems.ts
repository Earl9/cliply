...
return createSession(user);`,
  ...
  },
  {
    ...
    type: "text",
    title: "Windows-first 原则",
    previewText: "优先保证 Windows 版稳定可用，保持平台适配层清晰。",
    fullText: "优先保证 Windows 版稳定可用，保持平台适配层清晰。第一版不引入云服务，也不做账号系统。",
    sourceApp: "记事本",
...
ORDER BY rank;`,
  ...
  },
  {
    ...
    type: "text",
    title: "快捷键清单",
    previewText: "Enter 粘贴，Shift+Enter 无格式，Ctrl+P 固定，上下键选择。",
    fullText: "Enter 粘贴，Shift+Enter 无格式粘贴，Ctrl+P 固定，上下键选择。Ctrl+K 聚焦搜索框。",
    sourceApp: "Obsidian",
    sourceWindow: "Cliply shortcuts.md",
